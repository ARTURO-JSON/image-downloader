...
export default function SearchBar({ onSearch, initialValue = '' }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="w-full">
      <div className="relative shadow-md rounded-full transition-all duration-200 hover:shadow-lg focus-within:shadow-lg focus-within:ring-2 focus-within:ring-blue-400">
